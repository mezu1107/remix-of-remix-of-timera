...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.popups-ClWZ1EII.js
		...
		fields: [
			...
			},
			{
				...
				options: [
					...
					{
						label: "Exit intent (mouse leaves / back gesture)",
						value: "exit"
					},
					{
						label: "Delay or exit intent",
						value: "both"
					}
				]
			},
			...
			},
			{
				...
				options: [
					...
					{
						label: "Once per device (until dismissed)",
						value: "once"
					},
					{
...
//#endregion
export { PopupsAdmin as component };
