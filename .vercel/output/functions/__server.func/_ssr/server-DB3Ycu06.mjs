...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-Cugoymov.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dci3nvJS.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C8Azywtp.mjs"),
		import("./start-CYrwyEWP.mjs"),
