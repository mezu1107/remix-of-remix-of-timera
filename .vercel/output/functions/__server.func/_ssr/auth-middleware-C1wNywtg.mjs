...
//#region node_modules/.nitro/vite/services/ssr/assets/auth-middleware-C1wNywtg.js
...
var requireSupabaseAuth = createMiddleware({ type: "function" }).server(async ({ next }) => {
	...
	const SUPABASE_URL = (typeof process !== "undefined" ? process.env["SUPABASE_URL"] || process.env["VITE_SUPABASE_URL"] : void 0) || DEFAULT_SUPABASE_URL;
	const SUPABASE_PUBLISHABLE_KEY = (typeof process !== "undefined" ? process.env["SUPABASE_PUBLISHABLE_KEY"] || process.env["VITE_SUPABASE_PUBLISHABLE_KEY"] : void 0) || DEFAULT_SUPABASE_KEY;
