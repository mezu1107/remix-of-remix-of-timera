...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.deals-97VbWP-h.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CrudModule, {
		...
		fields: [
			...
			},
			{
				...
				label: "Ends",
				type: "datetime",
				help: "Powers the countdown on the storefront."
			},
			{
				key: "sort_order",
				label: "Sort order",
...
//#endregion
export { DealsAdmin as component };
